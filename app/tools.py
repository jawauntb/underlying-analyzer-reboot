...
def market_memo_prompt(report: dict[str, Any]) -> str:
    return (
        ...
        "`Rating: <rating>`, then follow with 2-3 concise sentences tying the rating to "
        "supplied evidence, uncertainty, and the strongest disconfirming signal. Do not add "
        "any section after this rating.\n\n"
