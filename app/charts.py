...
def render_ridge_growth_chart(
    ...
    price_ax.plot(data.index, data["major_ma"], color=MUTED, linewidth=1.6, label="Major SMA 200")
    ...
    equity_ax.axhline(RidgeGrowthConfig().initial_capital, color=MUTED, linestyle="--", alpha=0.62)
